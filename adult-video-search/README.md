...
1. Push this repo (or only the `adult-video-search` folder as its own repo).
2. In Netlify: **Add new site → Import an existing project**.
3. Set:
   - **Base directory**: `adult-video-search` (if this folder lives inside a monorepo)
